...
### Requisitos
a.Existe um exemplo de carga de banco de dados em memória em ProductDAoExampleTest.java
b.Os valores exibidos no checkout (frete, subtotal e total) devem ser calculados dinamicamente
c.O usuário poderá adicionar e remover produtos do carrinho
d.O usuário poderá ordenar os produtos por preço, popularidade (score) e ordem alfabética.
e.A cada produto adicionado, deve-se somar R$ 10,00 ao frete.
f.O frete é grátis para compras acima de R$ 250,00 (sem o frete dos demais produtos)
